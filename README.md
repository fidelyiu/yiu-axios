...
浏览器无其他依赖：
```html
<script src="https://unpkg.com/yiu-axios@1.0.44/yiu-axios.iife.min.js"></script>
```
...
<script src="https://unpkg.com/yiu-axios@1.0.44/yiu-axios.onlib.iife.min.js"></script>
```
